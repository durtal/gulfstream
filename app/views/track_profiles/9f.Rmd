...
ggplot(data = pctbtn, aes(x = gate, y = pct_btn)) +
    ...
    RcappeR::theme_rcapper() +
    labs(x = "Gate", y = "", title = "Percentage of Rivals Beaten (9f Dirt)")
```
</div>
<div class="col-sm-6">
```{r echo=FALSE, warning=FALSE, message=FALSE, out.height="300px", out.width="500px", fig.align='center'}
...
ggplot(tmp, aes(x = fs5f, y = ..density.., fill = Winner)) +
...
ggplot(data = pctbtn, aes(x = gate, y = pct_btn)) +
    geom_bar(fill = "#0BA42D", stat = "identity") +
    RcappeR::theme_rcapper() +
    labs(x = "Gate", y = "", title = "Percentage of Rivals Beaten (9f Turf)")
```
</div>
<div class="col-sm-6">
```{r echo=FALSE, warning=FALSE, message=FALSE, out.height="300px", out.width="500px", fig.align='center'}
